...
char*           p3t_timerGetElapsedAsString  (p3t_timer  *timer);
int             p3t_timerGetMinutes          (p3t_timer  *timer);
char*           p3t_timerGetMinutesAsString  (p3t_timer  *timer);
...
void            p3t_timerIncreaseMinutes     (p3t_timer  *timer);
void            p3t_timerDecreaseMinutes     (p3t_timer  *timer);
